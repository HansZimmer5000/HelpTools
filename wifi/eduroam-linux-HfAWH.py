...
Config.instname = "Hochschule für Angewandte Wissenschaften Hamburg"
Config.profilename = "eduroam"
Config.url = "https://wlan.haw-hamburg.de/"
Config.email = "wlan@haw-hamburg.de"
Config.title = "eduroam CAT"
Config.server_match = "radius.haw-hamburg.de"
...
Config.user_realm = "haw-hamburg.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.haw-hamburg.de']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@haw-hamburg.de"
Config.tou = ""
